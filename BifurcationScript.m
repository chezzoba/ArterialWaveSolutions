...
params = ["L1" "R1" "be1" "L2" "R2" "be2" "L3" "R3" "be3" "RW1" "RW2" "Cwk"];
xmin = [0.005,0,0,0.005,0,0,0.005,0,0,0,0,0];
xmax = [0.3,0.02,0.0025,0.3,0.02,0.0025,0.3,0.02,0.0025,740000000,5.22e+09,1e-7,];
