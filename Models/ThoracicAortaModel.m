classdef ThoracicAortaModel
    %THORAICAORTAMODEL Summary of this class goes here
    ...
    properties
        ...
        Inlet_pressure = load('PreviousCode/automeris/uper_thoracic_aorta/Inlet_pressure.csv');
        midpoint_pressure = load('PreviousCode/automeris/uper_thoracic_aorta/midpoint_pressure.csv');
        outlet_pressure = load('PreviousCode/automeris/uper_thoracic_aorta/outlet_pressure.csv');
        midpoint_flow = load('PreviousCode/automeris/uper_thoracic_aorta/midpoint_flow.csv');
        outlet_flow = load('PreviousCode/automeris/uper_thoracic_aorta/outlet_flow.csv');
    end
