...
function [Qout1,Qout2,Qout3,Qout4,Qout5,Qout6,Qout7,l,t] = aorta5(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,pt)
...
h = 0.1*Rin; %h was chosen to be 10% of Rd
Rin = Rin;
...
for i = 2:bounds
    ...
    if i < bounds
        ...
        k(i) = k(i-1) + int;
        Qin(k(i-1):k(i)) = Qin(k(i-1):k(i))*p(i-1);
        
    else
        
        Qin(k(i-1):end) = Qin(k(i-1):end)*p(i-1);
