...
load('automeris/tapered_carotid/inlet_pressure.csv')
load('automeris/tapered_carotid/mid_pressure.csv')
load('automeris/tapered_carotid/outlet_pressure.csv')
load('automeris/tapered_carotid/CC_mid.csv')
load('automeris/tapered_carotid/CC_outlet.csv')
load('automeris/tapered_carotid/pin_pout.csv')


x = CC_inlet_BC(1:end,1);
y = CC_inlet_BC(1:end,2)*10^-6;
N = length(y);
T = CC_inlet_BC(end,1);
xi = (x(1):T/((N)):T)';
yi = interp1q(x,y,xi);
