...
function [B1_A1,B2_A2,B3_A3,Yeff_1] = type_II_bifurcation(R1,R2,R3,L1,L2,L3,RW21,RW22,CWK2,RW31,RW32,CWK3,E1,E2,E3,h1,h2,h3,v1,v2,v3,rho1,rho2,rho3,omega,a1,a2,a3)
    
    %% Daughter vessel I --> 2
    %Calculation B2/A2
    Z2 = (RW21+RW22 - 1i*omega*RW21*RW22*CWK2)/(1-1i*omega*RW22*CWK2);
    s2out = (R2-tan(a2)*L2)/sin(a2);
    [J_13s2out,Y_13s2out,J_43s2out,Y_43s2out,fs2out] = besselfunctions(a2,s2out,omega,E2,rho2,v2,h2);      
    ...
    [J_13s2in,Y_13s2in,J_43s2in,Y_43s2in,fs2in] = besselfunctions(a2,s2in,omega,E2,rho2,v2,h2);      
    ...
    [J_13s3out,Y_13s3out,J_43s3out,Y_43s3out,fs3out] = besselfunctions(a3,s3out,omega,E3,rho3,v3,h3);      
    ...
    [J_13s3in,Y_13s3in,J_43s3in,Y_43s3in,fs3in] = besselfunctions(a3,s3in,omega,E3,rho3,v3,h3);      
    ...
    [J_13s1out,Y_13s1out,J_43s1out,Y_43s1out,fs1out] = besselfunctions(a1,s1out,omega,E1,rho1,v1,h1);      
    ...
    [J_13s1in,Y_13s1in,J_43s1in,Y_43s1in,fs1in] = besselfunctions(a1,s1in,omega,E1,rho1,v1,h1);      
